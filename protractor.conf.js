...
exports.config = {
	...
	/* The address of a running selenium server; if you do not want to have 3 command prompt
	just keep this as a comment
	...
	*/
	...
	// Note: issues with running on PhantomJS, so recommend to stick with chrome or something 
	// else
	multiCapabilities: [
		{
			'browserName': 'chrome'
